export default function createFooter(status) {
    ...
    footer.classList.add('bg-black', 'rounded-lg', 'h-12', 'w-11/12', 'm-auto', 'fixed', 'bottom-5', 'left-0', 'right-0', 'md:hidden');

    const nav = document.createElement('nav');
    nav.classList.add('flex', 'justify-between', 'px-7', 'h-full', 'w-full', 'max-w-80', 'm-auto');
